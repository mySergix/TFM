...
// Function to read txt files into arrays
...
// Function to run the reading of the data
...
// Function to delete all the memory of the ReadData class
void ReadData::Delete_ReadDataMemory(){

	delete GeometryData;
	delete ProblemNumericalData;
	delete ProblemData;
	delete ProblemPhysicalData;
