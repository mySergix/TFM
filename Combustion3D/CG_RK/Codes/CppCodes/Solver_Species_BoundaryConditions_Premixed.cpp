    ...
    if (Ix[Rango] <= NX_1){
        for (i = Ix[Rango]; i < min(Fx[Rango], NX_1); i++){
            for (k = 0; k < NZ; k++){
                ...
                // Species 0 - CH4
                Species[0].Bottom[BOTTOM(i,0,k)] = 0.20; //Species[0].Wmolar / (Species[0].Wmolar + 2.0 * Species[1].Wmolar + 2.0 * 3.76 * Species[4].Wmolar);

                // Species 1 - O2
                Species[1].Bottom[BOTTOM(i,0,k)] = 0.20; //Species[1].Wmolar / (Species[0].Wmolar + 2.0 * Species[1].Wmolar + 2.0 * 3.76 * Species[4].Wmolar);

                // Species 2 - CO2
                Species[2].Bottom[BOTTOM(i,0,k)] = 0.0; //0.0;

                // Species 3 - H2O
                Species[3].Bottom[BOTTOM(i,0,k)] = 0.20; //0.0;

                // Species 4 - N2
                Species[4].Bottom[BOTTOM(i,0,k)] = 0.20; //Species[4].Wmolar / (Species[0].Wmolar + 2.0 * Species[1].Wmolar + 2.0 * 3.76 * Species[4].Wmolar);
